...
# Possible targets
dict set target_dict vck190_fmcp1 { xilinx.com vck190 { 1 2 } { 0 0 1 1 } versal }
dict set target_dict vck190_fmcp2 { xilinx.com vck190 { 1 2 } { 0 0 0 1 } versal }
dict set target_dict vmk180_fmcp1 { xilinx.com vmk180 { 1 2 } { 0 0 1 1 } versal }
dict set target_dict vmk180_fmcp2 { xilinx.com vmk180 { 1 2 } { 0 0 0 1 } versal }
...
set bank_index [lindex [dict get $target_dict $target] 3]
